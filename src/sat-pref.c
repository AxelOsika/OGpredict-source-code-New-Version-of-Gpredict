...
const gchar    *WINDOW_TITLE[4] = {
    N_("OGPREDICT Preferences :: General"),
    N_("OGPREDICT Preferences :: Modules"),
    N_("OGPREDICT Preferences :: Interfaces"),
    N_("OGPREDICT Preferences :: Predict")
};
...
void sat_pref_run()
{
    ...
    window = gtk_dialog_new_with_buttons(_("OGpredict Preferences :: General"),
                                         GTK_WINDOW(app),
                                         GTK_DIALOG_MODAL |
