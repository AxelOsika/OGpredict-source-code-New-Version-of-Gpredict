...
GtkWidget      *sat_pref_conditions_create()
{
    ...
    gtk_widget_set_tooltip_text(res,
                                _("OGpredict will try to show the pass details "
    ...
    gtk_widget_set_tooltip_text(nument,
                                _("OGpredict will try to keep the number "
    ...
    gtk_widget_set_tooltip_text(tzero,
                                _("Check this box if you want OGpredict "
                                  "to always use "
                                  ...
                                  "active, OGpredict will use the time from the time controller "
