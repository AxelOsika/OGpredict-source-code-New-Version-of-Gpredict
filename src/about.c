...
const gchar *authors[] = {
    ...
    "",
    "- Axel Osika, OGpredict fork maintainer: Ephemeris Data window",
    "",
    ...
    "",
    "Data set for Territory Filter",
    "ESA WorldCover 10 m 2021 v200 — European Space Agency (ESA) WorldCover Consortium.",
    "DOI: 10.5281/zenodo.7254221. Licensed under Creative Commons Attribution 4.0 International (CC BY 4.0).",
...
void about_dialog_create()
{
    ...
    gtk_about_dialog_set_license_type(GTK_ABOUT_DIALOG(dialog),
                                      GTK_LICENSE_GPL_2_0);
    iconfile = logo_file_name("gpredict_icon_color.png");
