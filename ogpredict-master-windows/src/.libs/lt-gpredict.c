...
/* ./.libs/lt-gpredict.c - temporary wrapper executable for .libs/gpredict.exe
   Generated by libtool (GNU libtool) 2.5.4

   The gpredict program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "gpredict.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# gpredict - temporary wrapper script for .libs/gpredict.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.5.4\n", f);
  fputs ("#\n", f);
  fputs ("# The gpredict program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"gpredict.exe:gpredict:$LINENO: libtool wrapper (GNU libtool) 2.5.4\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"gpredict.exe:gpredict:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"gpredict.exe:gpredict:$LINENO: newargv[0]: $progdir\\\\$program\" 1", f);
  fputs (">&2\n", f);
