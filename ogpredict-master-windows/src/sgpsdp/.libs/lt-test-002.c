...
/* ./.libs/lt-test-002.c - temporary wrapper executable for .libs/test-002.exe
   Generated by libtool (GNU libtool) 2.5.4

   The test-002 program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "test-002.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test-002 - temporary wrapper script for .libs/test-002.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.5.4\n", f);
  fputs ("#\n", f);
  fputs ("# The test-002 program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"test-002.exe:test-002:$LINENO: libtool wrapper (GNU libtool) 2.5.4\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test-002.exe:test-002:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test-002.exe:test-002:$LINENO: newargv[0]: $progdir\\\\$program\" 1", f);
  fputs (">&2\n", f);
