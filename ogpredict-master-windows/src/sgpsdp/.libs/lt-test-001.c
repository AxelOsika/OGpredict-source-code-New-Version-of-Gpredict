...
/* ./.libs/lt-test-001.c - temporary wrapper executable for .libs/test-001.exe
   Generated by libtool (GNU libtool) 2.5.4

   The test-001 program cannot be directly executed until all the libtool
...
const char * EXE_PATH_VALUE   = "C:\\msys64\\mingw64\\bin\\..\\lib:C:\\msys64\\mingw64\\bin\\..\\bin;";
const char * TARGET_PROGRAM_NAME = "test-001.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test-001 - temporary wrapper script for .libs/test-001.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.5.4\n", f);
  fputs ("#\n", f);
  fputs ("# The test-001 program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"test-001.exe:test-001:$LINENO: libtool wrapper (GNU libtool) 2.5.4\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test-001.exe:test-001:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test-001.exe:test-001:$LINENO: newargv[0]: $progdir\\\\$program\" 1", f);
  fputs (">&2\n", f);
  ...
  fputs ("    PATH=C:/msys64/mingw64/bin/../lib:C:/msys64/mingw64/bin/../bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
