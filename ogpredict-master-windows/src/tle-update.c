...
#endif
/* Decide once if we're on Windows and expose GP_WIN32 consistently */
#ifndef GP_WIN32
#  if defined(_WIN32) || defined(__MINGW32__) || defined(__MINGW64__) || defined(G_OS_WIN32)
#    define GP_WIN32 1
#  else
#    define GP_WIN32 0
#  endif
...
#if GP_WIN32
    int      res  = 0;          /* win32_fetch() return code */
#else
    CURL    *curl = NULL;
