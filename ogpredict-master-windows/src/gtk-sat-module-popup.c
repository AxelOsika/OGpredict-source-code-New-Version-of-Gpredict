...
#else
    /* anchor the menu’s SE corner to the button’s NE corner */
    gtk_menu_popup_at_widget(
        GTK_MENU(menu),
        module->popup_button,      /* the “☰” button */
        GDK_GRAVITY_SOUTH_EAST,    /* menu’s corner */
        GDK_GRAVITY_NORTH_EAST,    /* button’s corner */
        NULL                       /* no GdkEvent*, let GTK pick the time */
    );
#endif
}
